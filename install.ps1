...
$defaultInstallerVersion = "0.1.4"
$defaultReleaseBundleUrl = "https://github.com/omerlefaruk/roi-h/releases/download/v0.1.8/roi-h-release-windows-x86_64-0.1.8.tar.gz"
$defaultReleaseBundleSha256 = "ff952335326f23a349ff2450e3dade1a4d795dd68ee9dc8e9ca4dac1ac8a922a"
